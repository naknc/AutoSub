...
class VideoPlayer(QtWidgets.QMainWindow):
	...
	def _build_ui(self):
		...
		hdr_wrap = QtWidgets.QVBoxLayout()
		hdr_wrap.setSpacing(self._compact_spacing)
		...
		actions.setSpacing(self._compact_spacing)
		lang_label = QtWidgets.QLabel("Subtitle Language")
		lang_label.setObjectName("sectionLabel")
		actions.addWidget(lang_label)
		...
		action_buttons.setHorizontalSpacing(self._compact_spacing)
		action_buttons.setVerticalSpacing(self._compact_spacing)
		...
		action_buttons.addWidget(self._sel_btn, 0, 0)
		self._download_btn = QtWidgets.QPushButton("Download Subs")
		self._download_btn.setObjectName("secondaryButton")
		self._download_btn.clicked.connect(self._download_subs)
		self._download_btn.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
		action_buttons.addWidget(self._download_btn, 0, 1)
		self._add_btn = QtWidgets.QPushButton("Add Videos")
		self._add_btn.clicked.connect(self._add_videos)
		self._add_btn.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
		action_buttons.addWidget(self._add_btn, 1, 0, 1, 2)
		action_buttons.setColumnStretch(0, 1)
		action_buttons.setColumnStretch(1, 1)
		actions.addLayout(action_buttons)
		...
		self._library_scroll = QtWidgets.QScrollArea()
		self._library_scroll.setWidgetResizable(True)
		self._library_scroll.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
		self._library_scroll.setWidget(self._pf)
		self._side_tabs.addTab(self._library_scroll, "Library")
		...
		btns.setHorizontalSpacing(self._compact_spacing)
		btns.setVerticalSpacing(self._compact_spacing)
		self._connect_btn = QtWidgets.QPushButton("Connect")
		self._connect_btn.clicked.connect(self._connect_sync)
		self._connect_btn.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
		btns.addWidget(self._connect_btn, 0, 0)
		...
		self._disconnect_btn.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
		btns.addWidget(self._disconnect_btn, 0, 1)
		btns.setColumnStretch(0, 1)
		...
		self._sync_status.setMinimumWidth(0)
		...
		self._sync_members.setMinimumWidth(0)
		...
		self._chat_list.setMinimumHeight(120)
		...
		chat_row = QtWidgets.QGridLayout()
		chat_row.setHorizontalSpacing(self._compact_spacing)
		chat_row.setVerticalSpacing(self._compact_spacing)
		...
		chat_row.addWidget(self._chat_input, 0, 0)
		...
		chat_row.addWidget(self._chat_send_btn, 0, 1)
		chat_row.setColumnStretch(0, 1)
		sl.addLayout(chat_row)
		sl.addStretch(1)
		self._together_scroll = QtWidgets.QScrollArea()
		self._together_scroll.setWidgetResizable(True)
		self._together_scroll.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
		self._together_scroll.setWidget(self._sync_frame)
		self._side_tabs.addTab(self._together_scroll, "Together")
		...
		control_wrap = QtWidgets.QVBoxLayout()
		control_wrap.setContentsMargins(self._card_margins, 12, self._card_margins, 12)
		control_wrap.setSpacing(10)
		...
		audio_controls.setVerticalSpacing(8)
		...
		audio_controls.addWidget(self._vol_label, 0, 2)
		...
		audio_controls.addWidget(vol, 0, 3)
		audio_controls.setColumnStretch(1, 1)
		audio_controls.setColumnStretch(3, 1)
		control_wrap.addLayout(audio_controls)
		...
		control_wrap.addWidget(self._status)
		self._ctrl_w.setLayout(control_wrap)
